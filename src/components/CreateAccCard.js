...
<span className="flex justify-between mt-4">
 ...
 <span className="">
    ...
    <input type="text" name="address" id="address" placeholder="Street 23, Burlington Road, #01-174, S410897" className="w-full px-4 py-3 rounded-lg bg-gray-200 mt-2 border focus:border-blue-500 focus:bg-white focus:outline-none" autofocus autocomplete required />
    </span>
