...
const DoctorCard = ({ img, name, languages,bio, gender,pricing, profession}) => {
    const [showBookingModal, setBookingModal] =useState(false)

    return (
        <div>
            {showBookingModal? <BookingModal pricing={pricing} name={name} profession={profession} setBookingModal={setBookingModal}/>:""}
